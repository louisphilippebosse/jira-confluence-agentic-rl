"""
RL Metrics API - Reinforcement learning metrics and progress
"""
...
async def get_rl_metrics() -> Dict[str, Any]:
    ...
    try:
        ...
        # Top 10 most valuable state-action pairs
        top_pairs = []
        for state_hash in agent.q_table:
        ...
        metrics["worst_state_actions"] = sorted(top_pairs, key=lambda x: x["q_value"])[:10]
